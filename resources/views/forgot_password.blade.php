...
@section('title', 'Gondal Rice: Forgot Password')
            ...
            <div class="row justify-content-md-center">
                <div class="col-md-8 p-b-50">
                    <div class="p-r-15 p-rl-0-lg">
                        ...
                        <form action="{{route('forgot_password')}}" class="how-bor3 p-rl-30 p-tb-32" method="post">
                            @csrf
                            <div class="p-b-24">
                                ...
                                <input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 focus1" type="email" name="email" value="{{old('email')}}" required />
                            </div>
