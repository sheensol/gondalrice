                                        ...
                                        <tbody>
                                            ...
                                            @foreach($categories as $key=>$category)
                                                <tr>
                                                    ...
                                                    <td><a href="{{route('admin.edit_category',$category->id)}}"><i class="fas fa-edit"></i></a> | <a href="{{route('admin.delete_category',$category->id)}}" onclick="return confirm('Are you sure you want to delete it?')"><i class="fas fa-trash text-danger"></i></a></td>
                                                </tr>
                                            @endforeach
