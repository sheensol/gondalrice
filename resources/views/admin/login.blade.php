...
<head>
    ...
    <title>Gondal Rice | Log in</title>
...
<div class="login-box">
    <div class="login-logo">
        <a href="../../index2.html"><b>Gondal</b>Rice</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <form action="{{route('admin.login')}}" class="how-bor3 p-rl-30 p-tb-32" method="post">
                @csrf
                ...
                <div class="input-group mb-3">
                    <input type="password" name="password" minlength="4" class="form-control" placeholder="Password">
                    <div class="input-group-append">
                        <div class="input-group-text">
