...
(function ($) {
    ...
    try {
        $("#radio1").on('change', function(){
            if ($(this).is(":checked")) {
                $('.content-cash').slideDown(300);
                $('.content-jazzcash').slideUp(300);
                $('.content-bank').slideUp(300);
            }
        });

        $("#radio2").on('change', function(){
            if ($(this).is(":checked")) {
                $('.content-jazzcash').slideDown(300);
                $('.content-cash').slideUp(300);
                $('.content-bank').slideUp(300);
